...
private:
	...
	// Creates a cork stopper
	void RenderCorkStopper();
	...
	// Creates a platform for the scene
	void RenderPlatform();
...
public:
	...
	// Load the light sources for the 3D scene
	void SetupSceneLights();

	// laods textures from the assets folder
	void LoadSceneTextures();

	// Load the object materials for lighting
